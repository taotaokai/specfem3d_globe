...
__global__ void compute_add_teleseismic_sources_kernel(float * accel, const float * field_teleseismic, const int interface_type, const int num_teleseismic_boundary_faces, const int * teleseismic_boundary_ispec, const int * ibool){
  int igll;
  int iface;
  int i;
  int j;
